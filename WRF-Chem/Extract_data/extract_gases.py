...
f = open('/media/noelia/TOSHIBA EXT/doctorado/usp/imagen_data/omi/OMNO2G_ori/data/2017_list_omi.txt')
satellite_txt = f.readlines()

wrf_file = sorted(glob("/scr2/rnoeliab/RESULTS/wrfout/2_dominio/cbmz_iag_ysu_2017/run_2017_c_bc/june/wrfout_d02_*"))  ## archivos wrfout
...
#ds_disk = xr.open_dataarray(output+"aod.avg.column.550.nc")
