...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 25 16:05:14 2021
...
####### directories ####
# import os
# satellite_path = '/media/noelia/TOSHIBA EXT/doctorado/usp/imagen_data/modis/DATA/SP/3K/2017/'
# satellite_txt = sorted(os.listdir(satellite_path))
# with open('/media/noelia/TOSHIBA EXT/doctorado/usp/imagen_data/modis/DATA/SP/3K/2017_list_modis.txt', 'w') as f:
#     for item in satellite_txt:
#         f.write("%s\n" % item)

f = open('/media/noelia/TOSHIBA EXT/doctorado/usp/imagen_data/modis/DATA/SP/3K/2017_list_modis.txt')
satellite_txt = f.readlines()

wrf_file = sorted(glob("/media/noelia/TOSHIBA EXT/doctorado/usp/modelo/DATA/wrfout_d02_*"))  ## archivos wrfout

output = "/media/noelia/TOSHIBA EXT/doctorado/usp/modelo/DATA/"
...
for n in range(len(djulian)):
    ...
    listdir += mod_wrf
with open('/media/noelia/TOSHIBA EXT/doctorado/usp/imagen_data/modis/DATA/SP/3K/list_mod_wrf.txt', 'w') as f:
     for item in listdir:
         f.write(item)   
###############################################################################    
